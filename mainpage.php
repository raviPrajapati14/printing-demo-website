    ...
    <div class="container-fluid w-50 m-auto">
        <form action=" " method="post">
            <div class="form-group">
              ...
              <input type="text" name="user" id="" class="form-control" placeholder="Enter User Name" aria-describedby="helpId">
            </div>
            <div class="form-group">
              <label for="">Email</label>
              <input type="E-mail" name="user" id="" class="form-control" placeholder="Enter User Name" aria-describedby="helpId">
            </div>
            <div class="form-group">
...
<footer class="bg-dark text-white p-2 mt-2 text-center">
<h4>@New Dipeshwari Printig Press</h4>
</footer>
