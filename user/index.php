    ...
    <button type="submit" class="btn btn-primary">Submit</button>
        ...
        <div class="col-lg-4 col-md-4 col-12 p-2">    
            ...
            <div class="p-3 text-center">
                <h5 class="p-3"> <i class="fas fa-mobile-alt"></i> Phone : </h5> <p>+91 9898212001 <br> +91 9727802002 </p>
                ...
                <h5 class="p-3"> <i class="far fa-envelope"></i> Email : </h5> <p>raviprajapati141297@gmail.com </p>
